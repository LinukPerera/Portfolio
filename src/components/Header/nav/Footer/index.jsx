...
export default function Index() {
    ...
    return (
        <div className={styles.footer}>
            ...
            <a className={styles.a} href="mailto:linukperera@icloud.com?subject=Hello&body=I'd like to connect with you!">Mail</a>
            <a className={styles.a} href="https://wa.me/+94773744055" target="_blank" rel="noopener noreferrer">WhatsApp</a>
        </div>
    )
}
